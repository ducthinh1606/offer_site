                        ...
                        <div class="card card-custom">
                            <div class="card-header">
                                <div class="card-title">
                                    ...
                                    <h3 class="card-label">Quản lý Application</h3>
                                ...
                                <div class="card-toolbar">
                                    ...
                                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#addApplication">
                                        Thêm Application
                                    </button>
                                    <!-- Modal-->


                                    <div class="modal fade" id="addApplication" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="exampleModalLabel">Thêm Application</h5>
                                                ...
                                                <div class="modal-body">
                                                    <div class="modal-body pd-20 pd-sm-30">
                                                        <h5 class="tx-18 tx-sm-20 mg-b-20">Add new Application</h5>
                                                        <hr>
                                                        <h5>Tên App</h5>
                                                        <div class="form-group">
                                                            <input type="text" id="app_name" class="form-control" placeholder="Tên app" aria-label="" aria-describedby="basic-addon1">
                                                        </div>
                                                        <h5>Chọn Network</h5>
                                                        <select id="app_network" class="browser-default custom-select custom-select-lg mb-3">
                                                            <option value="" disabled selected>Choose your option</option>
                                                            <?php
                                                            $stmt = $conn->prepare('select * from tblNetwork');
                                                            ...
                                                            foreach ($resultSet as $row) {
                                                                ?>
                                                                <option value="<?php echo $row['network_name'] ?>"><?php echo $row['network_name'] ?></option><?php }?>
                                                        </select>
                                                        <h5>URL</h5>
                                                        <div class="form-group">
                                                            <input type="text" id="app_url" class="form-control" placeholder="Nhập url" aria-label="" aria-describedby="basic-addon1">
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <button type="button" class="btn btn-primary font-weight-bold" id="btn_add">Add New Application</button>
                                                </div>
                                    ...
                                    <div class="modal fade" id="editApplication" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                ...
                                                <div class="modal-body">
                                                    <div class="modal-body pd-20 pd-sm-30">
                                                        ...
                                                        <h5>Tên App</h5>
                                                        <div class="form-group">
                                                            <input type="text" id="name" class="form-control" placeholder="Tên app" aria-label="" aria-describedby="basic-addon1">
                                                        </div>
                                                        <h5>Chọn Network</h5>
                                                        <select id="network" class="browser-default custom-select custom-select-lg mb-3">
                                                            <option value="" disabled selected>Choose your option</option>
                                                            <?php
                                                            $stmt = $conn->prepare('select * from tblNetwork');
                                                            $stmt->setFetchMode(PDO::FETCH_ASSOC);
                                                        ...
                                                        <h5>URL</h5>
                                                        <div class="form-group">
                                                            <input type="text" id="url" class="form-control" placeholder="Nhập url" aria-label="" aria-describedby="basic-addon1">
                                                        </div>
                                                    </div>
...
<script src="assets/js/pages/crud/datatables/data-sources/application.js?v=7.0.5"></script>
