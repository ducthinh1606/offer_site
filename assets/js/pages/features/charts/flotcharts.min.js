...
var KTFlotchartsDemo = function() {
    var e = function() {
        ...
        var a = null;
        $("#chart_2").bind("plothover", function(e, t, o) {
    ...
    return {
        init: function() {
            ...
            ! function() {
                ...
                var o = [];
                for (t = 0; t < 2 * Math.PI; t += .25) o.push([t, Math.cos(t)]);
                var a = [];
                for (t = 0; t < 2 * Math.PI; t += .1) a.push([t, Math.tan(t)]);
                ...
                function() {
                    for (var e = [], t = [], o = 0; o < 14; o += .1) e.push([o, Math.sin(o)]), t.push([o, Math.cos(o)]);
                    ...
                    function l() {
                        ...
                        if (!(e.x < t.xaxis.min || e.x > t.xaxis.max || e.y < t.yaxis.min || e.y > t.yaxis.max)) {
                            ...
                            for (o = 0; o < n.length; ++o) {
                                var c = n[o];
                                for (l = 0; l < c.data.length && !(c.data[l][0] > e.x); ++l);
                                var h, d = c.data[l - 1],
                                    p = c.data[l];
                                h = null == d ? p[1] : null == p ? d[1] : d[1] + (p[1] - d[1]) * (e.x - d[0]) / (p[0] - d[0]), i.eq(o).text(c.label.replace(/=.*/, "= " + h.toFixed(2)))
                            }
                        }
                    }
                ...
                function() {
                    ...
                    function o() {
                        for (e.length > 0 && (e = e.slice(1)); e.length < t;) {
                            var o = (e.length > 0 ? e[e.length - 1] : 50) + 10 * Math.random() - 5;
                            o < 0 && (o = 0), o > 100 && (o = 100), e.push(o)
                        }
                ...
                function() {
                    ...
                    var o = [];
                    for (t = 0; t <= 10; t += 1) o.push([t, parseInt(30 * Math.random())]);
                    var a = [];
