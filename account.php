...
<head>
   ...
   <link href="assets/css/themes/layout/header/menu/dark.css?v=7.0.5" rel="stylesheet" type="text/css" />
         ...
         <div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
            ...
            <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500">
               ...
               <ul class="menu-nav">
                  ...
                  <li class="menu-item menu-item-submenu-active" aria-haspopup="true">
...
<script src="assets/js/pages/crud/datatables/data-sources/account.js?v=7.0.5"></script>
