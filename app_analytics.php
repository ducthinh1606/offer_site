                  ...
                  <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
                     <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                        ...
                        <div class="d-flex align-items-center flex-wrap mr-2">
                           <!--begin::Page Title-->
                           <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">App Analytics</h5>
                           <!--end::Page Title-->
                           <!--begin::Actions-->
						 ...
						 <div class="row">
                           ...
                           <div class="card-header">
                              <div class="card-title">
                                 ...
                                 <h3 class="card-label">Thống Kê Chi Tiết Theo App</h3>
...
<script>
            ...
            var ctxapp1 = [20, 60, 50, 45, 50, 60, 70, 40, 45, 235, 25, 30, 40, 20, 30, 10, 22.5, 55.4, 33.2, 75.8, 45.2, 32.1, 20, 30.8, 50, 0, 0, 0, 0, 0];
            var ctxapp2 = [20, 30, 160, 40, 60, 102, 95, 45, 130, 80, 95, 70, 20, 10, 64, 23, 43, 23, 66, 21, 77, 88, 22, 66, 0, 0, 0, 0, 0, 0];
            var ctxapp3 = [10, 40, 30, 40, 40, 5, 23, 55, 40, 40, 5, 70, 220, 10, 64, 23, 43, 23, 65, 22, 127, 88, 22, 56, 0, 0, 0, 0, 0, 0];
